...
See Server and Client in [example/basic](https://github.com/rfyiamcool/registry-consul/tree/main/example/basic) or [example/custom-config](https://github.com/rfyiamcool/registry-consul/tree/main/example/custom-config).
